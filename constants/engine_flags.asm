...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_CITY_1
	const ENGINE_FLYPOINT_CITY_2
	const ENGINE_FLYPOINT_CITY_3
	const ENGINE_FLYPOINT_CITY_4
	const ENGINE_FLYPOINT_CITY_5
	const ENGINE_FLYPOINT_CITY_6
	const ENGINE_FLYPOINT_REST_AREA
	const ENGINE_FLYPOINT_CITY_7
	const ENGINE_FLYPOINT_CITY_8
	const ENGINE_FLYPOINT_CITY_9
	const ENGINE_FLYPOINT_CITY_10
	const ENGINE_FLYPOINT_ISLAND
	const ENGINE_FLYPOINT_SHIP_PLAYERS_CABIN
