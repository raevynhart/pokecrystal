...
Route35_MapEvents:
	...
	def_warp_events
	warp_event 17, 36, ROUTE_35_GOLDENROD_GATE, 1
	warp_event 17, 37, ROUTE_35_GOLDENROD_GATE, 2
	...
	bg_event 17, 33, BGEVENT_READ, Route35Sign
	...
	object_event  4, 34, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerCamperElliot, -1
	object_event  4, 30, SPRITE_LASS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerPicnickerBrooke, -1
	object_event 17, 23, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerPicnickerKim, -1
