...
GoldenrodCity_MapEvents:
	...
	def_warp_events
	warp_event 21,  9, GOLDENROD_GYM, 1
	warp_event 17, 11, GOLDENROD_BIKE_SHOP, 1
	warp_event 21, 11, GOLDENROD_HAPPINESS_RATER, 1
	warp_event  5, 11, BILLS_FAMILYS_HOUSE, 1
	warp_event  6,  3, GOLDENROD_MAGNET_TRAIN_STATION, 2
	warp_event 11,  3, GOLDENROD_FLOWER_SHOP, 1
	warp_event 19,  3, GOLDENROD_PP_SPEECH_HOUSE, 1
	warp_event  1,  3, GOLDENROD_NAME_RATER, 1
	warp_event 15,  3, GOLDENROD_DEPT_STORE_1F, 1
	warp_event  1, 11, GOLDENROD_GAME_CORNER, 1
	warp_event  5,  8, RADIO_TOWER_1F, 1
	warp_event  2,  0, ROUTE_35_GOLDENROD_GATE, 3
	warp_event  0,  0, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 8
	warp_event  7,  8, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 5
	warp_event  9, 11, GOLDENROD_POKECENTER_1F, 1

	def_coord_events

	def_bg_events
	bg_event  8,  4, BGEVENT_READ, GoldenrodCityStationSign
	bg_event  4,  8, BGEVENT_READ, GoldenrodCityRadioTowerSign
	bg_event 16,  3, BGEVENT_READ, GoldenrodDeptStoreSign
	bg_event 22,  9, BGEVENT_READ, GoldenrodGymSign
	bg_event 14,  7, BGEVENT_READ, GoldenrodCitySign
	bg_event 20, 20, BGEVENT_READ, GoldenrodCityBikeShopSign
	bg_event  2, 11, BGEVENT_READ, GoldenrodCityGameCornerSign
	bg_event  2,  3, BGEVENT_READ, GoldenrodCityNameRaterSign
	bg_event  1,  0, BGEVENT_READ, GoldenrodCityUndergroundSignNorth
	bg_event  4, 20, BGEVENT_READ, GoldenrodCityUndergroundSignSouth
	bg_event 10, 11, BGEVENT_UP, GoldenrodCityPokecenterSign
	bg_event 12,  3, BGEVENT_READ, GoldenrodCityFlowerShopSign

	def_object_events
	object_event  0, 12, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 20, 13, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event  4,  4, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 13, 12, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 16,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event  7, 12, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityLassScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 22,  5, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityGrampsScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 21,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocketScoutScript, EVENT_GOLDENROD_CITY_ROCKET_SCOUT
	object_event 20,  9, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket1Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	object_event 20,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket2Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	object_event 20,  7, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket3Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 23,  9, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket4Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 22,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket5Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 23,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket6Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 10,  7, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MoveTutorScript, EVENT_GOLDENROD_CITY_MOVE_TUTOR
