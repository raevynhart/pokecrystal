...
MapGroup_Special9:
	...
	map Special9, TILESET_KANTO, TOWN, LANDMARK_SPECIAL_9, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_9_MAPS

MapGroup_Special10:
	table_width MAP_LENGTH, MapGroup_Special10
	map Special10, TILESET_CAVE, TOWN, LANDMARK_SPECIAL_10, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
