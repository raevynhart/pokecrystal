...
MapGroup_City1:
	...
	map City1, TILESET_JOHTO, TOWN, LANDMARK_CITY_1, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route1, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CITY_1, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_CITY_1, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map C1NorthGate, TILESET_GATE, GATE, LANDMARK_SPECIAL_1, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITY_1_MAPS

MapGroup_City2:
	table_width MAP_LENGTH, MapGroup_City2
	map City2, TILESET_JOHTO, TOWN, LANDMARK_CITY_2, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map C2NorthGate, TILESET_GATE, GATE, LANDMARK_SPECIAL_2, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map C2EastGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map C2WestGate, TILESET_GATE, GATE, LANDMARK_ROUTE_1, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITY_2_MAPS

MapGroup_City3:
	table_width MAP_LENGTH, MapGroup_City3
	map City3, TILESET_JOHTO_MODERN, TOWN, LANDMARK_CITY_3, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_City4:
	...
	map City4, TILESET_LIGHTHOUSE, TOWN, LANDMARK_CITY_4, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_CITY_4_MAPS

MapGroup_City5:
	table_width MAP_LENGTH, MapGroup_City5
	map City5, TILESET_JOHTO_MODERN, TOWN, LANDMARK_CITY_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map R5SouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_CITY_5_MAPS

MapGroup_City6:
	table_width MAP_LENGTH, MapGroup_City6
	map City6, TILESET_JOHTO, TOWN, LANDMARK_CITY_6, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route8, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_8, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map C6EastGate, TILESET_GATE, GATE, LANDMARK_SPECIAL_6, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITY_6_MAPS

MapGroup_City7:
	table_width MAP_LENGTH, MapGroup_City7
	map City7, TILESET_JOHTO_MODERN, TOWN, LANDMARK_CITY_7, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map C7SouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_12, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CITY_7_MAPS

MapGroup_City8:
	table_width MAP_LENGTH, MapGroup_City8
	map City8, TILESET_KANTO, TOWN, LANDMARK_CITY_8, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_City9:
	...
	map City9, TILESET_CAVE, TOWN, LANDMARK_CITY_9, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Special1:
	...
	map Special1, TILESET_JOHTO, ROUTE, LANDMARK_SPECIAL_1, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_1_MAPS

MapGroup_Special2:
	table_width MAP_LENGTH, MapGroup_Special2
	map Special2, TILESET_JOHTO, ROUTE, LANDMARK_SPECIAL_2, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_2_MAPS

MapGroup_Special3:
	table_width MAP_LENGTH, MapGroup_Special3
	map Special3, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_SPECIAL_3, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_3_MAPS

MapGroup_Special4:
	table_width MAP_LENGTH, MapGroup_Special4
	map Special4, TILESET_JOHTO, ROUTE, LANDMARK_SPECIAL_4, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_4_MAPS

MapGroup_Special5:
	table_width MAP_LENGTH, MapGroup_Special5
	map Special5, TILESET_CAVE, CAVE, LANDMARK_SPECIAL_5, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_5_MAPS

MapGroup_Special6:
	table_width MAP_LENGTH, MapGroup_Special6
	map Special6, TILESET_JOHTO, ROUTE, LANDMARK_SPECIAL_6, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_6_MAPS

MapGroup_Special7:
	table_width MAP_LENGTH, MapGroup_Special7
	map Special7, TILESET_KANTO, TOWN, LANDMARK_SPECIAL_1, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_7_MAPS

MapGroup_Special8:
	table_width MAP_LENGTH, MapGroup_Special8
	map Special8, TILESET_CAVE, CAVE, LANDMARK_SPECIAL_8, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_8_MAPS

MapGroup_Special9:
	table_width MAP_LENGTH, MapGroup_Special9
	map Special9, TILESET_KANTO, ROUTE, LANDMARK_SPECIAL_9, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SPECIAL_9_MAPS

MapGroup_Special10:
	table_width MAP_LENGTH, MapGroup_Special10
	map Special10, TILESET_CAVE, CAVE, LANDMARK_SPECIAL_10, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
